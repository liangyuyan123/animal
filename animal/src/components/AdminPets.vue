<template>
  <div>
    <i-button type="primary" @click="showAdminPets">Primary</i-button>
    <Modal v-model="visibleAdminPets" title="新增">
...
<viewer>
             ...
             <Form-item>
                 <i-button type="primary" @click="handleSubmit('formPets')">提交</i-button>
                 <i-button type="primary" @click="handleReset('formPets')" style="margin-left: 8px">重置</i-button>
             </Form-item>
         </i-form>
         <div slot="footer"></div>
    </Modal>
